...
import abstract from '../assets/pdf/Research_Abstract.pdf'

import img from '../assets/png/nn.png'
export const projectsData = [
    {
        id: 1,
        projectName: 'An Analysis of Standard Model and Supersymmetric Sub-Atomic Particle Events',
        projectDesc: 'This Research Project is an accumulation of work from my last year as an Undergraduate Research Assistant. Feel Free to read through the Abstract and view the Poster we presented at the Undergraduate Research Symposium!',
        tags: ['Neural Networks', 'Deep Learning', 'Particle Physics'],
        code: research,
        demo: abstract,
        image: img
    }, 
